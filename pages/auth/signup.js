    ...
    <div className="min-h-screen flex items-start justify-center bg-background pt-20">
      <div className="max-w-md w-full bg-slate-900/95 backdrop-blur-xl border border-border rounded-2xl shadow-2xl p-8 space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-textSecondary">Join the Catalog community</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-surface/60 backdrop-blur-sm border border-border/50 rounded-xl p-2 shadow-lg">
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-accent hover:bg-accent/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent disabled:opacity-50"
            >
        ...
        <div className="text-center">
          <Link href="/auth/signin" className="text-accent hover:text-accent/80">
